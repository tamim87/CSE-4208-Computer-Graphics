...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		*/
		...
		sofa1.tox = 0.0;
		sofa1.toz = 0.27;
		ourShader = sofa1.ret_shader(ourShader, VAO, VAOF3, VAO3, VAO2, VAOW2);
		//ourShader = sofa1.local_rotation(ourShader, VAO, VAOF3, VAO2, VAO2, VAOW2);
		...
		sofa2.tox = 6.0;
		sofa2.toz = -3.0;
		//ourShader = sofa2.ret_shader(ourShader, VAO, VAOF3, VAO3, VAO2, VAOW2);
		ourShader = sofa2.local_rotation(ourShader, VAO, VAOF3, VAO2, VAO2, VAOW2, 270);
		...
		t1.tox = 1.6;
		t1.toz = -4.0;
		ourShader = t1.ret_shader(ourShader, VAO, VAOF3, VAO3, VAO2, VAOW2);
		//ourShader = t1.local_rotation(ourShader, VAO, VAOF3, VAO2, VAO2, VAOW2,0);
		...
		r1.toy = -.75;
		r1.toz = -9;
		//ourShader = l1.local_rotation(ourShader, VAOW1, 90);
		ourShader = r1.ret_shader(ourShader, VAOW1);
		*/
		...
		//rack
		model = transforamtion(-2.0, -.75 + 2 +1.2, -9, rotateAngle_X, rotateAngle_Y, rotateAngle_Z, 4.5, 0.2, 2);
		ourShader.setMat4("model", model);
		glBindVertexArray(VAO4);
		glDrawElements(GL_TRIANGLES, 36, GL_UNSIGNED_INT, 0);

		//rack
		model = transforamtion(0.0, -.75 + 2 +0.6, -9, rotateAngle_X, rotateAngle_Y, rotateAngle_Z, 4.5, 0.2, 2);
		ourShader.setMat4("model", model);
		glBindVertexArray(VAO4);
		glDrawElements(GL_TRIANGLES, 36, GL_UNSIGNED_INT, 0);

		//rack
		model = transforamtion(2.0, -.75 + 2 , -9, rotateAngle_X, rotateAngle_Y, rotateAngle_Z, 4.5, 0.2, 2);
		ourShader.setMat4("model", model);
		glBindVertexArray(VAO4);
		glDrawElements(GL_TRIANGLES, 36, GL_UNSIGNED_INT, 0);
		...
		//Cabinate
		model = transforamtion(6.74, -.75, 1, rotateAngle_X, rotateAngle_Y, rotateAngle_Z, 1.5, 2, 3);
		ourShader.setMat4("model", model);
		glBindVertexArray(VAOC);
		glDrawElements(GL_TRIANGLES, 36, GL_UNSIGNED_INT, 0);
		...
		//cabinet splitter
		model = transforamtion(6.73, -.75, 1+.78, rotateAngle_X, rotateAngle_Y, rotateAngle_Z, 1.5, 1.9998, .03);
		ourShader.setMat4("model", model);
		glBindVertexArray(VAOB);
		glDrawElements(GL_TRIANGLES, 36, GL_UNSIGNED_INT, 0);
		...
		////sofa back
		//model = transforamtion(-1.5, -.75, -9, rotateAngle_X, rotateAngle_Y, rotateAngle_Z, .2, 8, 18);
		//ourShader.setMat4("model", model);
		//glBindVertexArray(VAOW2);
		//glDrawElements(GL_TRIANGLES, 36, GL_UNSIGNED_INT, 0);

		////sofa side
		//model = transforamtion(-1.5, -.75, -9, rotateAngle_X, rotateAngle_Y, rotateAngle_Z, .2, 10, 24);
		//ourShader.setMat4("model", model);
		//glBindVertexArray(VAOW2);
		//glDrawElements(GL_TRIANGLES, 36, GL_UNSIGNED_INT, 0);
		...
		//model = transforamtion(0.09, 0.1, 2, rotateAngle_X, rotateAngle_Y, rotateAngle_Z, .08, .2, .08);
		////modelMatrices.push_back(model);
		//ourShader.setMat4("model", model);
		//glBindVertexArray(VAOG);
		//glDrawElements(GL_TRIANGLES, 84, GL_UNSIGNED_INT, 0);
		//
		//model = transforamtion(0.09, 0.09, 2, rotateAngle_X, rotateAngle_Y, rotateAngle_Z, .08, -1.64, .08);
		////modelMatrices.push_back(model);
		//ourShader.setMat4("model", model);
		//glBindVertexArray(VAOW1);
		//glDrawElements(GL_TRIANGLES, 36, GL_UNSIGNED_INT, 0);
		//
		//model = transforamtion(0.09, -0.72, 2, rotateAngle_X, rotateAngle_Y, rotateAngle_Z, .08, .01, .08);
		////modelMatrices.push_back(model);
		//ourShader.setMat4("model", model);
		//glBindVertexArray(VAOW2);
		//glDrawElements(GL_TRIANGLES, 84, GL_UNSIGNED_INT, 0);
